...
import ProductCard from '@/components/common/product/ProductCard.vue'
...
<template>
  <div class="p-6">
    ...
    >
      <ProductCard v-for="product in filteredProducts" :key="product.id" :product="product" /> //we
      use filtered products always.
    </div>
  </div>
</template>
